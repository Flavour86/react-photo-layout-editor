...
var Block = function (_React$Component) {
	...
	_createClass(Block, [{
		...
		value: function componentDidMount() {
			// set dom
			this.$self = $(_reactDom2.default.findDOMNode(this._self));
		}
	}, {
		...
		value: function _moveStart(e) {
			...
			$(document).on(controlEvent.move + '.move', function (e) {
		...
		value: function _moveEnd(e) {
			...
			$(document).off(controlEvent.move + '.move').off(controlEvent.end + '.move');
		}
	}, {
		key: '_resizeStart',
		value: function _resizeStart(e) {
			...
			$(document).on(controlEvent.move + '.resize', function (e) {
		...
		value: function _resizeIng(e) {
			...
			// set mouse position
			var distanceX = (evt.clientX || evt.pageX) + $(window).scrollLeft() - this.resizeStartInfo.mouseX;
		...
		value: function _resizeEnd(e) {
			...
			$(document).off(controlEvent.move + '.resize').off(controlEvent.end + '.resize');
		}
	}, {
		key: 'render',
