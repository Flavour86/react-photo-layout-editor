...
var Cropper = function (_React$Component) {
	...
	function Cropper(props) {
		...
		_this._block = null;
		_this.$item = $(props.element).find('.react-grid-item').filter('[data-key=' + cropper.key + ']');
		...
		_this.simulationMousewheel = _this.simulationMousewheel.bind(_this);
		return _this;
	}
	...
	_createClass(Cropper, [{
		...
		value: function componentDidMount() {
			...
			setTimeout(function () {
				_this2.mask = document.querySelector('.ple-cropper__bg');
				_this2.scrollContainer = document.querySelector('.ple-grid__wrap');
				_this2.mask && _this2.scrollContainer && _this2.mask.addEventListener('mousewheel', _this2.simulationMousewheel);
			}, 200);
		}
	}, {
		key: 'simulationMousewheel',
		value: function simulationMousewheel(e) {
